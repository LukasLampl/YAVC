...
public class MakroDifferenceEngine {
	 ...
	 */
	public ArrayList<MakroBlock> get_MakroBlock_difference(ArrayList<MakroBlock> list1, ArrayList<MakroBlock> list2, PixelRaster img, int EDGE_TOLERANCE) {
	 ...
	 * 			int EDGE_TOLERANCE => Tolerance with which edges are filtered
	 */
	private boolean is_edge(MakroBlock block, PixelRaster img, int EDGE_TOLERANCE) {
		int strength = 0;
	...
	private int calculate_sobel_operator(PixelRaster img, int x, int y) {
		int gx = 0, gy = 0;
